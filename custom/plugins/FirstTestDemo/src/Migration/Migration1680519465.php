...
class Migration1680519465 extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement("CREATE TABLE IF NOT EXISTS`first_test_demo` (
            ...
            CONSTRAINT `fk.first_test_demo.country_state_id` FOREIGN KEY (`country_state_id`) REFERENCES `state` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
